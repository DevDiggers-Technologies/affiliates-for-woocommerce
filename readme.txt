...
**[Affiliates for WooCommerce plugin](https://devdiggers.com/product/woocommerce-affiliates/)** lets you recruit, manage, and pay affiliates from your WordPress admin. Affiliates get a dedicated dashboard where they can generate referral links, track clicks and conversions, view their unpaid earnings, and save their payout details. Your store tracks every referral automatically using a cookie, applies the commission when an order completes, and records it in a queue for you to pay out.
...
* [View Free Demo](https://demo.devdiggers.com/woocommerce-affiliates-free/)
* [View Pro Demo](https://demo.devdiggers.com/woocommerce-affiliates/)
* [Full Documentation](https://devdiggers.com/affiliates-for-woocommerce/)
* [Free vs Pro Comparison](https://devdiggers.com/knowledge-base/woocommerce-affiliates-plugin-free-vs-pro/)
* [Upgrade to Pro](https://devdiggers.com/product/woocommerce-affiliates/)
...
* Use the `[ddwcaf_affiliate_registration_form_shortcode]` shortcode to create a dedicated affiliate signup page
* Use the default WooCommerce registration form or build a custom page using only the shortcode
...
* Set the referral query variable name to any string you prefer - the default is `ref`
* Configure the cookie name to match your store's naming conventions
...
* HPOS declared compatible with WooCommerce High-Performance Order Storage
...
[View the Free Version Live Demo](https://demo.devdiggers.com/woocommerce-affiliates-free/)

---

== Affiliates for WooCommerce Pro ==

The Pro version adds automation, multi-tier commissions, sophisticated anti-fraud controls, and marketing tools that turn your affiliates into active promoters. [See everything included in Pro](https://devdiggers.com/product/woocommerce-affiliates/).
...
[View the Pro Version Live Demo](https://demo.devdiggers.com/woocommerce-affiliates/)
[Upgrade to Pro](https://devdiggers.com/product/woocommerce-affiliates/)
...
1. Install and activate Affiliates for WooCommerce from the WordPress plugin directory.
2. Go to **DevDiggers Plugins > Affiliates > Configuration** and set your global commission rate and cookie expiration period.
3. Create an affiliate registration page and add the `[ddwcaf_affiliate_registration_form_shortcode]` shortcode to it.
4. Set that page as your affiliate dashboard page in the configuration panel.
5. Affiliates register through your signup page and wait for admin approval.
6. Once approved, affiliates log in, generate their referral links from the dashboard, and start promoting.
7. When a referred visitor places an order, the commission is recorded automatically and appears in the commissions list for you to pay out.
...
* [WooCommerce Wallet](https://devdiggers.com/product/woocommerce-wallet-management/) payout method
...
[See the full Free vs Pro comparison](https://devdiggers.com/knowledge-base/woocommerce-affiliates-plugin-free-vs-pro/)
...
2. Search for **Affiliates for WooCommerce**.
...
1. Navigate to **DevDiggers Plugins > Affiliates** in the admin sidebar.
2. Go to **Configuration > General** and enable the affiliate module.
3. Set your commission rate under **Configuration > Commissions**.
4. Create a page, add the `[ddwcaf_affiliate_registration_form_shortcode]` shortcode, and assign it as the affiliate dashboard page under **Configuration > General**.
5. Share the registration page URL with potential affiliates and start reviewing applications from the Affiliates list.
...
Yes. A live demo of the free version is available at [demo.devdiggers.com/woocommerce-affiliates-free/](https://demo.devdiggers.com/woocommerce-affiliates-free/) and the Pro demo is at [demo.devdiggers.com/woocommerce-affiliates/](https://demo.devdiggers.com/woocommerce-affiliates/).
...
Post in the support forum here on WordPress.org for free version questions. Full documentation is available at [devdiggers.com/affiliates-for-woocommerce/](https://devdiggers.com/affiliates-for-woocommerce/) with step-by-step setup guides. Pro license holders get direct priority support from the DevDiggers team.

== Screenshots ==

1. Admin panel affiliate dashboard showing total earnings, paid earnings, unpaid earnings, and quick stats at a glance along with various charts.
2. Affiliate dashboard showing total earnings, paid earnings, unpaid earnings, and quick stats at a glance
3. Affiliate commissions list showing commission amounts, order references, dates, and statuses
4. Affiliate payouts page showing payout history and current payment status for each request
5. Affiliate visits list showing click log with referral source URLs and timestamps
6. Affiliate top products list showing which products generated the most commission revenue
7. Affiliate link generator where affiliates create referral links for any page or product
8. Affiliate registration and login page created using the provided shortcode
9. Admin affiliates list showing all registered affiliates with status and earnings summary
10. Admin view affiliate page showing full profile details and commission history for one affiliate
11. Admin commissions list with filters for status, date, and affiliate name
12. Admin payouts list with manual payout management and status controls
13. Admin top products report showing which products drive the most affiliate revenue across all affiliates
14. Admin visits log showing all referral clicks with affiliate, URL, and timestamp data
15. Registration fields configuration panel
16. General configuration panel for enabling the module, setting the dashboard page, and user role options
17. Referrals configuration panel for cookie name, expiration, and visit registration settings
18. Commissions configuration panel for global commission rate and tax/discount exclusion options
19. Payouts configuration panel for available withdrawal methods and payout settings
20. Shortcodes configuration panel showing the available shortcode strings for registration and dashboard
