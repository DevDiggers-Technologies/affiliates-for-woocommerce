				...
				if ( ! empty( $_POST[ 'custom_page_url' ] ) ) {
                    ...
                    <p>
                        <label>
                            ...
                            <input type="text" class="ddwcaf-custom-page-url form-control" value="<?php echo esc_attr( $custom_url ); ?>" />
                        </label>
                    </p>
                    <p>
                    ...
                    <?php
                    if ( ! empty( $this->ddwcaf_configuration[ 'referral_social_share_options' ] ) ) {
                        ?>
