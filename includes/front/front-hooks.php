...
if ( ! class_exists( 'DDWCAF_Front_Hooks' ) ) {
	...
	class DDWCAF_Front_Hooks extends DDWCAF_Front_Functions {
		...
		public function __construct( $ddwcaf_configuration ) {
			...
			add_action( 'woocommerce_applied_coupon', [ $this, 'ddwcaf_handle_applied_coupon' ] );
			...
			add_action( 'woocommerce_store_api_checkout_order_processed', [ $this, 'ddwcaf_handle_store_api_checkout_order_processed' ], 10, 1 );
