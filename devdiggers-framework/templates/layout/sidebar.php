...
<div class="ddfw-template-container">
	...
	if ( ! empty( $tabs ) && is_array( $tabs ) ) {
		...
		<button class="ddfw-mobile-settings-toggle" type="button" aria-label="<?php esc_attr_e( 'Toggle Settings', 'affiliates-for-woocommerce' ); ?>">
		...
		<nav class="ddfw-left-tab-wrapper">
			...
			<button class="ddfw-mobile-settings-close" type="button" aria-label="<?php esc_attr_e( 'Close Settings', 'affiliates-for-woocommerce' ); ?>">
