...
<div class="devdiggers-wrap">
    ...
    <div class="ddfw-dashboard-header">
        ...
        <div class="ddfw-dashboard-welcome">
            <h1><?php printf( esc_html__( 'Hello, %s!', 'loyaltyx-points-and-rewards-for-woocommerce' ), esc_html( $current_user->display_name ) ); ?></h1>
            <p><?php esc_html_e( 'Browse and explore our premium extensions for your WooCommerce store.', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?></p>
        </div>
    ...
    <div class="ddfw-dashboard-stats">
        <div class="ddfw-stat-card">
            ...
            <div class="ddfw-stat-content">
                ...
                <p><?php esc_html_e( 'Total Extensions', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?></p>
            </div>
        </div>
        ...
        <div class="ddfw-stat-card">
            ...
            <div class="ddfw-stat-content">
                ...
                <p><?php esc_html_e( 'Years Experience', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?></p>
            </div>
        </div>
        ...
        <a href="https://www.trustpilot.com/review/devdiggers.com" target="_blank" class="ddfw-stat-card ddfw-stat-card-link">
            ...
            <div class="ddfw-stat-content">
                <h3><?php esc_html_e( 'Excellent', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?></h3>
        ...
        <div class="ddfw-stat-card">
            ...
            <div class="ddfw-stat-content">
                <h3><?php esc_html_e( 'Online', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?></h3>
                <p><?php esc_html_e( '24/7 Support', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?></p>
            </div>
        </div>
    </div>
    ...
    <div class="ddfw-dashboard-section">
        <div class="ddfw-section-header">
            <h2><?php esc_html_e( 'Featured Extensions', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?></h2>
        </div>
                    ...
                    <div class="ddfw-plugin-footer">
                        <div class="ddfw-plugin-actions">
                            <a href="<?php echo esc_url( $plugin['url'] ); ?>" target="_blank" class="ddfw-button ddfw-button-primary">
                                <?php esc_html_e( 'Buy Now', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?>
                            ...
                            <?php if ( ! empty( $plugin['demo_url'] ) ) : ?>
                                <a href="<?php echo esc_url( $plugin['demo_url'] ); ?>" class="ddfw-button ddfw-button-secondary" target="_blank">
                                    <?php esc_html_e( 'Live Demo', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?>
                                </a>
                            <?php endif; ?>
                            <?php if ( ! empty( $plugin['documentation_url'] ) ) : ?>
                                <a href="<?php echo esc_url( $plugin['documentation_url'] ); ?>" class="ddfw-button ddfw-button-secondary" target="_blank">
                                    <?php esc_html_e( 'Documentation', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?>
                                </a>
                            <?php endif; ?>
                        </div>
                    </div>
    ...
    <div class="ddfw-dashboard-section">
        <div class="ddfw-section-header">
            <h2><?php esc_html_e( 'All Extensions', 'loyaltyx-points-and-rewards-for-woocommerce' ); ?></h2>
        </div>
